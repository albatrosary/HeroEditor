...
import * as import21 from 'angular2-in-memory-web-api/in-memory-backend.service';
...
import * as import29 from '../components/shared/hero.service';
import * as import30 from '../components/shared/in-memory-data.service';
import * as import31 from '@angular/core/src/di/injector';
import * as import32 from '../components/dashboard/dashboard.component.ngfactory';
import * as import33 from '../components/hero-detail/hero-detail.component.ngfactory';
import * as import34 from '../components/heroes/heroes.component.ngfactory';
...
import * as import43 from '../components/dashboard/dashboard.component';
import * as import44 from '../components/hero-detail/hero-detail.component';
import * as import45 from '../components/heroes/heroes.component';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __XHRBackend_33:import21.InMemoryBackendService;
  ...
  __HeroService_49:import29.HeroService;
  __SEED_DATA_50:import30.InMemoryDataService;
  __TRANSLATIONS_FORMAT_51:any;
  constructor(parent:import31.Injector) {
    super(parent,[
      import32.DashboardComponentNgFactory,
      import33.HeroDetailComponentNgFactory,
      import34.HeroesComponentNgFactory,
  ...
  get _APP_ID_17():any {
    if ((this.__APP_ID_17 == (null as any))) { (this.__APP_ID_17 = import36._appIdRandomProviderFactory()); }
  ...
  get _EventManager_21():import15.EventManager {
    if ((this.__EventManager_21 == (null as any))) { (this.__EventManager_21 = new import15.EventManager(this._EVENT_MANAGER_PLUGINS_20,this.parent.get(import39.NgZone))); }
  ...
  get _RootRenderer_25():any {
    if ((this.__RootRenderer_25 == (null as any))) { (this.__RootRenderer_25 = import40._createConditionalRootRenderer(this._DomRootRenderer_24,this.parent.get(import40.NgProbeToken,(null as any)))); }
  ...
  get _XHRBackend_33():import21.InMemoryBackendService {
    if ((this.__XHRBackend_33 == (null as any))) { (this.__XHRBackend_33 = new import21.InMemoryBackendService()); }
    return this.__XHRBackend_33;
  }
  get _RequestOptions_34():import22.BaseRequestOptions {
    if ((this.__RequestOptions_34 == (null as any))) { (this.__RequestOptions_34 = new import22.BaseRequestOptions()); }
    return this.__RequestOptions_34;
  }
  get _Http_35():any {
    if ((this.__Http_35 == (null as any))) { (this.__Http_35 = import8.httpFactory(this._XHRBackend_33,this._RequestOptions_34)); }
  ...
  get _ROUTER_CONFIGURATION_39():any {
    if ((this.__ROUTER_CONFIGURATION_39 == (null as any))) { (this.__ROUTER_CONFIGURATION_39 = {}); }
    return this.__ROUTER_CONFIGURATION_39;
  }
  get _LocationStrategy_40():any {
    if ((this.__LocationStrategy_40 == (null as any))) { (this.__LocationStrategy_40 = import7.provideLocationStrategy(this.parent.get(import41.PlatformLocation),this.parent.get(import42.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_39)); }
  ...
  get _ROUTES_45():any[] {
      if ((this.__ROUTES_45 == (null as any))) { (this.__ROUTES_45 = [[
        ...
        {
          path: 'dashboard',
          component: import43.DashboardComponent
        }
        ,
        {
          path: 'detail/:id',
          component: import44.HeroDetailComponent
        }
        ,
        {
          path: 'heroes',
          component: import45.HeroesComponent
        }
  ...
  get _Router_46():any {
    if ((this.__Router_46 == (null as any))) { (this.__Router_46 = import7.setupRouter(this._ApplicationRef_15,this._UrlSerializer_42,this._RouterOutletMap_43,this._Location_41,this,this._NgModuleFactoryLoader_44,this._Compiler_16,this._ROUTES_45,this._ROUTER_CONFIGURATION_39)); }
    return this.__Router_46;
  }
  get _ActivatedRoute_47():any {
    if ((this.__ActivatedRoute_47 == (null as any))) { (this.__ActivatedRoute_47 = import7.rootRoute(this._Router_46)); }
    return this.__ActivatedRoute_47;
  }
  get _APP_BOOTSTRAP_LISTENER_48():any[] {
    if ((this.__APP_BOOTSTRAP_LISTENER_48 == (null as any))) { (this.__APP_BOOTSTRAP_LISTENER_48 = [import7.initialRouterNavigation(this._Router_46,this._ROUTER_CONFIGURATION_39)]); }
    return this.__APP_BOOTSTRAP_LISTENER_48;
  }
  get _HeroService_49():import29.HeroService {
    if ((this.__HeroService_49 == (null as any))) { (this.__HeroService_49 = new import29.HeroService(this._Http_35)); }
    return this.__HeroService_49;
  }
  get _SEED_DATA_50():import30.InMemoryDataService {
    if ((this.__SEED_DATA_50 == (null as any))) { (this.__SEED_DATA_50 = new import30.InMemoryDataService()); }
    return this.__SEED_DATA_50;
  }
  ...
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_5 = import7.provideForRootGuard(this.parent.get(import46.Router,(null as any)));
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import48.LOCALE_ID)) { return this._LOCALE_ID_9; }
    if ((token === import9.NgLocalization)) { return this._NgLocalization_10; }
    if ((token === import49.ErrorHandler)) { return this._ErrorHandler_11; }
    ...
    if ((token === import50.DOCUMENT)) { return this._DOCUMENT_18; }
    ...
    if ((token === import51.AnimationDriver)) { return this._AnimationDriver_23; }
    if ((token === import17.DomRootRenderer)) { return this._DomRootRenderer_24; }
    if ((token === import52.RootRenderer)) { return this._RootRenderer_25; }
    if ((token === import18.DomSanitizer)) { return this._DomSanitizer_26; }
    if ((token === import53.Sanitizer)) { return this._Sanitizer_27; }
    if ((token === import19.ViewUtils)) { return this._ViewUtils_28; }
    if ((token === import54.IterableDiffers)) { return this._IterableDiffers_29; }
    if ((token === import55.KeyValueDiffers)) { return this._KeyValueDiffers_30; }
    ...
    if ((token === import56.XHRBackend)) { return this._XHRBackend_33; }
    if ((token === import22.RequestOptions)) { return this._RequestOptions_34; }
    if ((token === import57.Http)) { return this._Http_35; }
    ...
    if ((token === import7.ROUTER_CONFIGURATION)) { return this._ROUTER_CONFIGURATION_39; }
    if ((token === import42.LocationStrategy)) { return this._LocationStrategy_40; }
    ...
    if ((token === import59.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_44; }
    if ((token === import60.ROUTES)) { return this._ROUTES_45; }
    if ((token === import46.Router)) { return this._Router_46; }
    if ((token === import61.ActivatedRoute)) { return this._ActivatedRoute_47; }
    if ((token === import36.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_48; }
    if ((token === import29.HeroService)) { return this._HeroService_49; }
    if ((token === import21.SEED_DATA)) { return this._SEED_DATA_50; }
    if ((token === import62.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_51; }
